...
import { NewCourseForm } from './features/admin/new-course-form/new-course-form';
...
export const routes: Routes = [
    ...
    {
        path: 'admin',
        loadChildren: () => import('./features/admin/admin-module').then(m => m.AdminModule) // Lazy load AdminModule for /admin path
    }
]
