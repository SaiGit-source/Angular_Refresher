...
export class CourseCard {
  // ? mark allows null values as well
  @Input() course?: Course; // In a real application, you would likely define a Course interface and use that instead of 'any'. 
  ...
  @Output() courseBookedListener = new EventEmitter<Course>(); // Event emitter to notify parent component about booking
  @Output() addWishlistListener = new EventEmitter<Course>(); // Event emitter to notify parent component about adding to wishlist
